...
def _build_keyword_index():
    ...
    print(f"[+] 키워드 인덱스 구축 완료: {len(KEYWORD_INDEX)}개 키워드")
...
def reload_documents():
    ...
    모델은 이미 로드되어 있어야 합니다 (SEMB_MODEL이 있어야 함).
    """
